                ...
                >
                    <ProForm
                        ...
                        initialValues={{
                            type: 1,
                            QuestionOptions: [
                                { is_answer: 1 }, { is_answer: 1 }, { is_answer: 1 }, { is_answer: 1 }
                            ]
                        }}
                        onFinish={async (values) => {
                            ...
                            const result = await questionApi.create(values);
                            if (result.code === 1) {
                    ...
                    >
                        <div style={{ width: '100%', display: activeKey == '1' ? 'block' : 'none' }}>
                            <Lazyload>
                                <Form1 formRef={formRef} typeAction='create'/>
                            </Lazyload>
                        </div>
                        <div style={{ display: activeKey == '2' ? 'block' : 'none' }}>
                            <Lazyload>
                                <Form2 formRef={formRef} typeAction='create'/>
                            </Lazyload>
                        </div>
                    </ProForm>
                </Card>
