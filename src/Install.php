...
class Install
{
    ...
    protected static $pathRelation = [
        '/plugin/teaching'            => '/plugin/teaching',
		
        '/public/admin_react/src/api/examinationPaper.js'      => '/public/admin_react/src/api/examinationPaper.js',
        '/public/admin_react/src/api/examinationPaperClass.js'      => '/public/admin_react/src/api/examinationPaperClass.js',
        '/public/admin_react/src/api/examinationResult.js'      => '/public/admin_react/src/api/examinationResult.js',
        '/public/admin_react/src/api/examinationResultQuestion.js'      => '/public/admin_react/src/api/examinationResultQuestion.js',
        '/public/admin_react/src/api/grade.js'      => '/public/admin_react/src/api/grade.js',
        '/public/admin_react/src/api/question.js'      => '/public/admin_react/src/api/question.js',
        '/public/admin_react/src/api/questionClass.js'      => '/public/admin_react/src/api/questionClass.js',
		
        '/public/admin_react/src/components/selectQuestionAll.jsx'      => '/public/admin_react/src/components/selectQuestionAll.jsx',
		
        '/public/admin_react/src/pages/teaching'       => '/public/admin_react/src/pages/teaching',
    ];
